          ...
          <div className="content">
            <div className="section">
              <p className="body-text">
                Welcome to UTX.io ("we," "us," or "our"), the informational resource for UTX Protocol, as defined below.
              </p>
              <p className="body-text">
                UTX.io provides information and resources about the fundamentals of the decentralized non-custodial
                protocol called the UTX Protocol (the "UTX Protocol," "Protocol," or "UTX DApp"). UTX.io is not an
                available access point to the UTX Protocol.
              </p>
              <p className="body-text">
                ...
                and conditions by which you may access UTX.io ("the Site") and app.UTX.io ("the Interface"). Please do
            ...
            <div className="section">
              ...
              <p className="body-text">The UTX.io site is for informational purposes only.</p>
              <p className="body-text">
                UTX.io is not part of any transaction on the blockchain networks underlying the UTX Protocol; we do not
                ...
                any crypto assets. You understand that when you interact with any UTX Protocol smart contracts, you
                always retain control over your crypto assets. We do not have access to your private keys.
              </p>
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    1.1. As a condition to accessing or using the Site or Interface, you represent and warrant to UTX.io
                    the following:
                  </p>
                  <ul className="list-style-none">
                    <li>
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        administrative authority having jurisdiction over UTX.io or you as otherwise duly enacted,
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        ...
                        procedures or repairs that UTX.io or any of its suppliers or contractors may undertake from time
                        to time; (c) causes beyond UTX.io's control or that UTX.io could not reasonably foresee; (d)
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        transaction with UTX.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">1.2.5. UTX.io does not act as a broker or advisor for you;</p>
                    </li>
                    <li>
                      <p className="body-text">
            ...
            <div className="section">
              ...
              <p className="body-text">
                ...
                fees. UTX.io does not receive fees for any blockchain transactions or using the Site or the Interface.
              </p>
            </div>
            <div className="section">
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    4.1. UTX.io own all rights, names, logos, and other marks used on the Site and the Interface,
                    including, without limitation, any copyrights in and to any content, code, data, or other materials
                    that you may access or use on or through the Site or the Interface; however, the code for the UTX
                    Protocol and the Interface (app.UTX.io) deployed on IPFS is open-sourced. Except as expressly set
                ...
                <li>
                  <p className="body-text">
                    4.2. UTX.io may use and share your comments, bug reports, ideas, or other feedback that you may
                    provide, including suggestions about how we might improve. You agree that UTX.io is free to use or
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    5.1. UTX.io reserve the right, at our sole discretion, from time to time and with or without prior
                    ...
                    own its code. UTX.io will not be liable for any losses suffered by you resulting from any
                ...
                <li>
                  <p className="body-text">
                    5.2. UTX.io may revise these Terms from time to time. We will notify you by updating the date at the
                    top of the Terms and maintaining a current version. The most current version of the Terms will
                    always be at https://utx.io/#/terms-and-conditions. All modifications will be effective when they
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    ...
                    others, entails a risk that by accessing transactions, you are assuming. UTX.io does not own or
                  ...
                  <ul className="list-style-none">
                    <li>
                      <p className="body-text">
                        6.1.1. That UTX.io is not responsible for the operation of the open-source software and networks
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        blockchain-based network. Neither UTX.io nor any other person or entity will be able to retrieve
                ...
                <li>
                  <p className="body-text">
                    6.2. UTX.io is not responsible for the content of any third party, including, but not limited to,
                    information, materials, products, or services that UTX.io does not own or control. In addition,
                    third parties may offer promotions related to your access and use of the Interface. UTX.io does not
                    ...
                    You expressly relieve UTX.io of all liability arising from using such resources or participating in
                    such promotions.
                  </p>
                </li>
                <li>
                ...
                <li>
                  <p className="body-text">
                    6.6. You hereby assume and agree that UTX.io will have no responsibility or liability for the risks
                    in Section 9. You hereby irrevocably waive, release and discharge all claims, whether known or
                    unknown to you, against UTX.io, its affiliates, and their respective shareholders, members,
                  ...
                  <ul className="list-style-none">
                    ...
                    <li>
                      <p className="body-text">
                        ...
                        right of publicity, privacy, or any other proprietary right of UTX.io;
                      </p>
                    </li>
                    <li>
                      <p className="body-text">
                    ...
                    <li>
                      <p className="body-text">
                        7.1.6. Harass, abuse, or harm another person or entity, including UTX.io's collaborator and
                        service providers;
                      </p>
                    </li>
                    <li>
            ...
            <div className="section">
              ...
              <p className="body-text">
                UTX.io is an informational site for the UTX Protocol. UTX.io does not operate an exchange platform or
              ...
              <p className="body-text">
                You understand that UTX.io is not registered or licensed by any regulatory agency or authority. No such
                agency or authority has reviewed or approved the use of the Site or the Interface.
              </p>
              <p className="body-text">
                You agree that the Site and the Interface are provided on an "AS IS" and "AS AVAILABLE" basis. UTX.io
            ...
            <div className="section">
              ...
              <p className="body-text">
                In no event shall UTX.io, its affiliates, its suppliers and contractors, and its affiliates', suppliers'
                ...
                or the Interface, or other item provided by or on behalf of UTX.io, whether under contract, tort
                ...
                or any limited remedy hereunder nor is UTX.io in any way responsible for the execution or settlement of
                transactions between users of the Interface.
              </p>
              <p className="body-text">
                In no event shall UTX.io's aggregate liability arising out of or in connection with the Site or
            ...
            <div className="section">
              ...
              <p className="body-text">
                You will defend, indemnify, and hold harmless UTX.io, its affiliates, members, member, managers,
            ...
            <div className="section">
              ...
              <p className="body-text">
                UTX.io will use its best efforts to resolve potential disputes through informal, good faith
                negotiations. If a potential dispute arises, you must contact us by sending a written notice of your
                claim ("Notice") to UTX.io on any of our official channels. The notice must (a) describe the nature and
                basis of the claim and (b) set forth the specific relief sought. Our notice to you will be similar in
                form to that described above. If you and UTX.io cannot reach an agreement to resolve the claim within
                sixty (60) days of your email, then you and UTX.io agree to resolve the potential dispute according to
              ...
              <p className="body-text">
                ...
                year after such claim arose; otherwise, the claim is permanently barred, which means that you and UTX.io
            ...
            <div className="section">
              ...
              <ul className="list-style-none">
                <li>
                  <p className="body-text">
                    13.1. Any right or remedy of UTX.io set forth in these Terms is in addition to, and not in lieu of,
                    any other right or remedy whether described in these Terms, under Applicable Law, at law, or in
                    equity. The failure or delay of UTX.io in exercising any right, power, or privilege under these
                ...
                <li>
                  <p className="body-text">
                    13.4. UTX.io will have no responsibility or liability for any failure or delay in performance of the
                ...
                <li>
                  <p className="body-text">
                    13.6. These Terms contain the entire agreement between you and UTX.io and supersede all prior and
            ...
            <div className="section">
              ...
              <p className="body-text">
                If you have any questions about these Terms, the Site, or the Interface, please get in touch with UTX.io
