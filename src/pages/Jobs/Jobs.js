    ...
    <Card title={t`No open positions at UTX currently`}>
      <div className="body-para">
        <p className="subheading">
          <Trans>
            UTX is not actively looking for new hires at the moment. However, if you think you can contribute to the
            project, please email <ExternalLink href="mailto:jobs@utx.io">jobs@utx.io</ExternalLink>.
          </Trans>
        </p>
      </div>
    </Card>
