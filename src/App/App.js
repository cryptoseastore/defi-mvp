...
import BuyUlp from "pages/BuyUlp/BuyUlp";
import BuyUTX from "pages/BuyUTX/BuyUTX";
...
const ftmWsProvider = new ethers.providers.JsonRpcProvider("https://fantom-testnet.publicnode.com");
ftmWsProvider.pollingInterval = 2000;

const u2uWsProvider = new ethers.providers.JsonRpcProvider("https://rpc-nebulas-testnet.uniultra.xyz");
u2uWsProvider.pollingInterval = 10000;
